...
const Addcustomer = () => {
  ...
  const loadData = useCallback(async()=>{
    const response = await axios.get(`http://localhost:4000/bookingclient/get/${book_id}`);
  ...
  const handleSubmit = (e) =>{
    ...
    if( !from_date || !to_date || !shoot_type || !name || !contact || !email || !address)
        ...
        if(!book_id){
            axios.post("http://localhost:4000/bookingclient/post",{
            ...
            axios.put(`http://localhost:4000/bookingclient/update/${book_id}`,{
  ...
  return (
    ...
    <br></br>
    <center>
    <h1 style={{fontSize:'70px'}}>BOOKING</h1></center>
    <div style={{marginTop: '100px'}}>
        ...
        >
            ...
            <label htmlFor='shoot_type'>Shoot type</label>
             <select id="cars" name="shoot_type"  value={shoot_type||""} onChange={handleInputChange} >
            ...
            />
            <br></br>
            <input type='submit' value={book_id?"Update":"Book"}/>
            <Link to='/'>
